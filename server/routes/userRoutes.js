...
const {registerController, loginController,singleUser, getAllUser, userUpdate,deleteUser, resetpassword, saveUserForgotPassword,} = require("../controllers/userController");
